...
while(True):
    ...
    if count < 25.0 : #Camera1 name000        
        ret, frame = cap2.read()
        if count >= 3.0 and count <= 4.0 : Control_Camera(1,0,0) #rotation
        elif count >= 21.0 and count <= 22.0 : process(2) #Send Photo

    elif count >= 25.0 and count < 45 : #Camera2 name001
        ret, frame = cap2.read()
        if count >= 30.0 and count <= 31.0 : Control_Camera(1,1,3) # left
        elif count >= 41.0 and count <= 42.0 : process(2) #Send Photo

    elif count >= 45.0 and count < 75 : #Camera2 name002
        ret, frame = cap2.read()
        if count >= 50.0 and count <= 51.0 : Control_Camera(1,2,6) # right
        elif count >= 70.0 and count <= 71.0 : process(2) #Send Photo
    
    elif count >= 75.0 : #Camera2 name002
        ret, frame = cap2.read()
